...
var loader = new PIXI.loaders.Loader('https://hackuab.com/images/',30);
...
function onresizeScreen() {
  if (screen.width<1536) {
    castle.initScaleX=0.5*screen.width/730/2
  }
}
...
function onAssetsLoaded(loader,resources){
  ...
  waterSurfaceB = new FloatingObject( "water-surface-b.png", illu, { depth:12, initPcX:.35, initPcY:.91, initDispY:-65, hideBelowX:sizeS });

  waterSurfaceC = new FloatingObject( "water-surface-c.png", illu, { depth:12, initPcX:.45, initPcY:.91, initDispY:-65, hideBelowX:sizeS });

  waterSurfaceD = new FloatingObject( "water-surface-d.png", illu, { depth:12, initPcX:.65, initPcY:.91, initDispY:-65, hideBelowX:sizeS });

  waterSurfaceE = new FloatingObject( "water-surface-e.png", illu, { depth:12, initPcX:.85, initPcY:.91, initDispY:-65, hideBelowX:sizeS });
  ...
  beachLeft = new FloatingObject( "beach-left.png", illu, { depth:21, initPcX:.17, initPcY:.91, hideBelowX:sizeS });

  beachRight = new FloatingObject( "beach-left.png", illu, { depth:21, initPcX:.9, initPcY:.91, initScaleX:-.5, hideBelowX:sizeS });

  smallShipBottomRight = new FloatingObject( "small-ship-bottom-right.png", illu, { depth:21, initPcX:.82, initPcY:.8, hideBelowX:sizeS});

  swordTreeLeft = new FloatingObject( "sword-tree-left.png", illu, { depth:22, initPcX:.17, initPcY:.91, hideBelowX:sizeS });

  treesLeft = new FloatingObject( "trees-left.png", illu, { depth:22, initPcX:.11, initPcY:.86, hideBelowX:sizeS });

  columnLeft = new FloatingObject( "column-left.png", illu, { depth:25, initPcX:.05, initPcY:1, initDispY:-150, hideBelowX:sizeS });

  treeBottomRight = new FloatingObject( "tree-bottom-right.png", illu, { depth:25, initPcX:.95, initPcY:1, initDispY:-150, hideBelowX:sizeS });
